...
struct RecorderFeatureStrings {
    ...
    let cameraToggle: String
    let cameraCaption: String
    let cameraTrackLabel: String
    let cameraUnavailableHUD: String
    let cameraShowToggle: String
    let cameraShapeCircle: String
    let cameraShapeRectangle: String
    let cameraFollowToggle: String
    let cameraMirrorToggle: String
...
extension RecorderFeatureStrings {
    static let enUS = RecorderFeatureStrings(
        ...
        cameraToggle: "Record the camera",
        cameraCaption: "The camera goes into a video of its own, so you can move it and resize it in the editor.",
        cameraTrackLabel: "Camera",
        cameraUnavailableHUD: "Camera unavailable",
        cameraShowToggle: "Show the camera",
        cameraShapeCircle: "Circle",
        cameraShapeRectangle: "Rectangle",
        cameraFollowToggle: "Follow the recording",
        cameraMirrorToggle: "Mirror the camera",
    ...
    static let ptBR = RecorderFeatureStrings(
        ...
        cameraToggle: "Gravar a câmera",
        cameraCaption: "A câmera vai para um vídeo separado, e você pode movê-la e redimensioná-la no editor.",
        cameraTrackLabel: "Câmera",
        cameraUnavailableHUD: "Câmera indisponível",
        cameraShowToggle: "Mostrar a câmera",
        cameraShapeCircle: "Círculo",
        cameraShapeRectangle: "Retângulo",
        cameraFollowToggle: "Seguir a gravação",
        cameraMirrorToggle: "Espelhar a câmera",
        audioVolumeLabel: "Volume",
        removeAudio: "Remover",
    ...
    static let tr = RecorderFeatureStrings(
        ...
        cameraToggle: "Kamerayı kaydet",
        cameraCaption: "Kamera ayrı bir videoya kaydedilir ve düzenleyicide taşınıp boyutlandırılabilir.",
        cameraTrackLabel: "Kamera",
        cameraUnavailableHUD: "Kamera kullanılamıyor",
        cameraShowToggle: "Kamerayı göster",
        cameraShapeCircle: "Daire",
        cameraShapeRectangle: "Dikdörtgen",
        cameraFollowToggle: "Kaydı takip et",
        cameraMirrorToggle: "Kamerayı aynala",
    ...
    static let ru = RecorderFeatureStrings(
        ...
        cameraToggle: "Записывать камеру",
        cameraCaption: "Камера пишется в отдельное видео, и её можно двигать и менять в размере в редакторе.",
        cameraTrackLabel: "Камера",
        cameraUnavailableHUD: "Камера недоступна",
        cameraShowToggle: "Показывать камеру",
        cameraShapeCircle: "Круг",
        cameraShapeRectangle: "Прямоугольник",
        cameraFollowToggle: "Следовать за записью",
        cameraMirrorToggle: "Отразить камеру",
    ...
    static let es = RecorderFeatureStrings(
        ...
        cameraToggle: "Grabar la cámara",
        cameraCaption: "La cámara va a un vídeo aparte y puedes moverla y cambiar su tamaño en el editor.",
        cameraTrackLabel: "Cámara",
        cameraUnavailableHUD: "Cámara no disponible",
        cameraShowToggle: "Mostrar la cámara",
        cameraShapeCircle: "Círculo",
        cameraShapeRectangle: "Rectángulo",
        cameraFollowToggle: "Seguir la grabación",
        cameraMirrorToggle: "Reflejar la cámara",
    ...
    static let de = RecorderFeatureStrings(
        ...
        microphoneTrackLabel: "Mikrofon",
        cameraToggle: "Kamera aufnehmen",
        cameraCaption: "Die Kamera kommt in ein eigenes Video und lässt sich im Editor bewegen und skalieren.",
        cameraTrackLabel: "Kamera",
        cameraUnavailableHUD: "Kamera nicht verfügbar",
        cameraShowToggle: "Kamera zeigen",
        cameraShapeCircle: "Kreis",
        cameraShapeRectangle: "Rechteck",
        cameraFollowToggle: "Aufnahme folgen",
        cameraMirrorToggle: "Kamera spiegeln",
    ...
    static let fr = RecorderFeatureStrings(
        ...
        cameraShapeRectangle: "Rectangle",
        cameraFollowToggle: "Suivre l’enregistrement",
        cameraMirrorToggle: "Mettre la caméra en miroir",
        audioVolumeLabel: "Volume",
        removeAudio: "Retirer",
    ...
    static let it = RecorderFeatureStrings(
        ...
        cameraToggle: "Registra la fotocamera",
        cameraCaption: "La fotocamera va in un video a parte e nell’editor puoi spostarla e ridimensionarla.",
        cameraTrackLabel: "Fotocamera",
        cameraUnavailableHUD: "Fotocamera non disponibile",
        cameraShowToggle: "Mostra la fotocamera",
        cameraShapeCircle: "Cerchio",
        cameraShapeRectangle: "Rettangolo",
        cameraFollowToggle: "Segui la registrazione",
        cameraMirrorToggle: "Rispecchia la fotocamera",
        audioVolumeLabel: "Volume",
        removeAudio: "Rimuovi",
    ...
    static let ja = RecorderFeatureStrings(
        ...
        cameraToggle: "カメラを録画",
        cameraCaption: "カメラは別の動画として記録され、エディタで位置と大きさを変えられます。",
        cameraTrackLabel: "カメラ",
        cameraUnavailableHUD: "カメラを使用できません",
        cameraShowToggle: "カメラを表示",
        cameraShapeCircle: "円",
        cameraShapeRectangle: "長方形",
        cameraFollowToggle: "録画に追従",
        cameraMirrorToggle: "カメラを左右反転",
        audioVolumeLabel: "音量",
        removeAudio: "削除",
        restoreAudio: "復元",
    ...
    static let ko = RecorderFeatureStrings(
        ...
        cameraToggle: "카메라 녹화",
        cameraCaption: "카메라는 별도의 영상으로 녹화되며 편집기에서 위치와 크기를 바꿀 수 있습니다.",
        cameraTrackLabel: "카메라",
        cameraUnavailableHUD: "카메라를 사용할 수 없습니다",
        cameraShowToggle: "카메라 표시",
        cameraShapeCircle: "원",
        cameraShapeRectangle: "사각형",
        cameraFollowToggle: "녹화를 따라가기",
        cameraMirrorToggle: "카메라 좌우 반전",
        audioVolumeLabel: "음량",
        removeAudio: "제거",
        restoreAudio: "복원",
    ...
    static let zhHans = RecorderFeatureStrings(
        ...
        cameraToggle: "录制相机",
        cameraCaption: "相机会录成单独的视频，可在编辑器中移动和缩放。",
        cameraTrackLabel: "相机",
        cameraUnavailableHUD: "相机不可用",
        cameraShowToggle: "显示相机",
        cameraShapeCircle: "圆形",
        cameraShapeRectangle: "矩形",
        cameraFollowToggle: "跟随录制",
        cameraMirrorToggle: "镜像相机",
        audioVolumeLabel: "音量",
        removeAudio: "移除",
        restoreAudio: "恢复",
    ...
    static let zhTW = RecorderFeatureStrings(
        ...
        cameraToggle: "錄製相機",
        cameraCaption: "相機會錄成獨立的影片，可在編輯器中移動和縮放。",
        cameraTrackLabel: "相機",
        cameraUnavailableHUD: "相機無法使用",
        cameraShowToggle: "顯示相機",
        cameraShapeCircle: "圓形",
        cameraShapeRectangle: "矩形",
        cameraFollowToggle: "跟隨錄製",
        cameraMirrorToggle: "鏡像相機",
        audioVolumeLabel: "音量",
        removeAudio: "移除",
        restoreAudio: "還原",
    ...
    static let zhHK = RecorderFeatureStrings(
        ...
        cameraToggle: "錄製相機",
        cameraCaption: "相機會錄成獨立影片，可以喺編輯器度移動同縮放。",
        cameraTrackLabel: "相機",
        cameraUnavailableHUD: "相機無法使用",
        cameraShowToggle: "顯示相機",
        cameraShapeCircle: "圓形",
